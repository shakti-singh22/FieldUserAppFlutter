...
class _PWSPendingapprovalState extends State<OfflineentriesOtherassets> {
  ...
  Future<void> getallotherassetssavedofflineentry_villageidwise(
    ...
    await databaseHelperJalJeevan?.getallotherassetssavedofflineentry_villageidwise(widget.villageid).then((value) {
      _loading = false;
                        ...
                        children: [
                          _loading == true
                              ...
                              : Container(
                                  ...
                                  child: localotherassetsofflinelist.length == 0
                                      ? const Center(
                                          child: SizedBox(
                                              child: Text(
                                          "No data found",
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onPressed:
                                                                              ...
                                                                              Get.to(ZoomImage(
                                                                                ...
                                                                                lat: localotherassetsofflinelist[index].latitude,
                                                                                long: localotherassetsofflinelist[index].longitude,
                                                                              ));
                                                                            },
                                                                            icon:
                                                                                const Icon(
